...
export default function CryptoInvestments(){
    const cryptoInvestmentsData = useLoaderData()
    ...
    return(
        <div>
            <div className="filter-and-amount-container">
                ...
                <AmountTitle componentTitle="Total Crypto Investments" amountOfMoney={1.0450033} selectCurrency={fiatCurrencyOptions} amountStyle={styles}/>
            </div>

            <div className="amount-list-and-report-container">
                <div className="amount-list">
                    {cryptoInvestmentsData.map((data, index)=>(
                        <div key={index}>
