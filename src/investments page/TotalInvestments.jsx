...
export default function TotalInvestments(){
    const totalInvestmentsData = useLoaderData()
    ...
    return(
        <div>
            <div className="filter-and-amount-container">
                ...
                <AmountTitle componentTitle="Total Investments" amountOfMoney={147000} selectCurrency={fiatCurrencyOptions} amountStyle={styles}/>
            </div>

            <div className="amount-list-and-report-container">
                <div className="amount-list">
                    {totalInvestmentsData.map((data, index)=>(
                        <div key={index}>
