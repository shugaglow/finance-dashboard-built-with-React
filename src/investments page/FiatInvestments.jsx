...
export default function FiatInvestments(){
    const fiatInvestmentsData = useLoaderData()
    ...
    return(
        <div>
            <div className="filter-and-amount-container">
                ...
                <AmountTitle componentTitle="Total Fiat Investments" amountOfMoney={147000} selectCurrency={fiatCurrencyOptions} amountStyle={styles}/>
            </div>

            <div className="amount-list-and-report-container">
                <div className="amount-list">
                    {fiatInvestmentsData.map((data, index)=>(
                        <div key={index}>
