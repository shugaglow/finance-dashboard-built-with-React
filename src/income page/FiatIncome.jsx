    ...
    return(
        <div>
            <div className="filter-and-amount-container">
                ...
                <AmountTitle componentTitle="Total Fiat Income" amountOfMoney={147000} selectCurrency={fiatCurrencyOptions} amountStyle={styles}/>
            </div>

            <div className="amount-list-and-report-container">
                <div className="amount-list">
                    {/* <AmountList/> */}
                    {fiatData.map((data, index)=>(
                        <div key={index}>
